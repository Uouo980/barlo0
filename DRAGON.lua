...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒ :\na▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒ :\na▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n\27[0;33;49m')
...
io.write('\27[1;31m ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Uouo980/barlo0/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1978999018,000000000000000000,7777777777777777777777,1001132193}   
...
local UserName = (data.username_ or "bar_lo0o0")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《♡ 𝘽𝘼𝙍𝙇𝙊》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'باور') 
local DRAGON_Msg = { 
...
local Text = ' ✇تم ارسال الملصق من ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Uouo980/barlo0/main/DRAGON.lua')
...
if text == 'اوامر المسح 🌚💞' and DevSoFi(msg) then 
...
if text == '▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒' and DevSoFi(msg) then
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/bar_lo0o0)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/bar_lo0o0"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ✇ من أحسن السورسات على التليجرام سورس باور ✇
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "باور")
...
send(msg.chat_id_,0," ✇ الـعـضو  : {["..data.first_name_.."](T.ME/bar_lo0o0)}\n ✇ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✇ عذرا  ↜:{["..data.first_name_.."](T.ME/bar_lo0o0)}\n ✇ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
★ 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐑𝐋𝐎 ★

╭─-─── • ★ • ───-─╮

 [★ ┋𝐃𝐀𝐃‌ " 𝐒𝐓𝐄𝐕𝐄𝐍 ┋★](t.me/DAD_STEVEN)

 [★ ٰ⠇ٰ‌𝐃𝐀𝐃 𝐁𝐀𝐑𝐋𝐎 ٖ⠇ٰ‌★](t.me/bar_lo0o0)

 [𝐂𝐇 𝐁𝐀𝐑𝐋𝐎𝐎𝐎 ](t.me/bar_lo0o0o0o0o)

╰──-── • ★ • ───-─╯
★ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐍 𝐓𝐋𝐄𝐆𝐑𝐀𝐌 ★

]] 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '★ ٰ⠇ٰ‌𝐃𝐀𝐃 𝐁𝐀𝐑𝐋𝐎 ٖ⠇ٰ‌★ ', url="t.me/bar_lo0o0"}},
{{text = '★ ┋𝐃𝐀𝐃‌ " 𝐒𝐓𝐄𝐕𝐄𝐍 ┋★ ', url="t.me/DAD_STEVEN"}},
{{text = '★  ⠇ٰ‌𝐁𝐀𝐑𝐋𝐎 𝐁𝐎𝐓 ٖ⠇ٰ‌★  ',url="t.me/barlo0o_bot"}},
{{text = '★》𝐂𝐇 𝐁𝐀𝐑𝐋𝐎𝐎𝐎《★ ',url="t.me/bar_lo0o0o0o0o"}},
{{text = '🌚💞 • اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '🎯رواية "أرض زيكولا"',url="https://t.me/bar_lo0o0"}},
{{text = '🎯موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '🎯رواية "الشفق الجزء الأول"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "المخلوق', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "بعد النسيان"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯رواية "واختفى كل شئ"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯رواية "نيلوفر أسود"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯رواية"جثة في الفندق"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯رواية "في القطار السريع"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯لقاء مع كاتب رعب"', url="https://t.me/t.me/bar_lo0o0"}},
{{text = '🎯رواية"الإنسان الأخير""', url="https://t.me/t.me/bar_lo0o0"}},
...
local Text = [[
مطورين ومبرمجين سورس باور اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 𝘽𝘼𝙍𝙇𝙊',url="t.me/ALEX_EL_KABEER"}},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝘽𝘼𝙍𝙇𝙊](http://t.me/bar_lo0o0)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝘽𝘼𝙍𝙇𝙊》 ', url="t.me/bar_lo0o0"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝘽𝘼𝙍𝙇𝙊》', url="t.me/XV_POF"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/FTAGC/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب باور' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/bar_lo0o0)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local bar_lo0o0 = database:get(bot_id..'text:ch:user')
if bar_lo0o0 then
send(msg.chat_id_, msg.id_,'['..bar_lo0o0..']')
else
...
if tonumber(result.sender_user_id_) == tonumber(000000000000000000) then  
...
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج باور عام 🚫")
return false 
end
...
function(arg,data) 
usertext = '\n ✇ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0')..')'
...
if result.id_ == tonumber(000000000000000000) then
send(msg.chat_id_, msg.id_, " ✇ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1001132193) then
send(msg.chat_id_, msg.id_, " ✇ لا يمكنك حظر مبرمج جميع السورسات\n")
return false 
end
...
usertext = '\n ✇ العضو ← ['..result.title_..'](t.me/'..(username or 'bar_lo0o0')..')'
status  = '\n ✇ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(000000000000000000) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✇")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1978999018) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم باور عام لانه هكر 🌚😹")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Uouo980/barlo0/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✇ اهلا بك في متجر ملفات باور\n ✇ ملفات السورس ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n\n"
local TextE = "\n▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n ✇ علامة تعني { ✔️ } ملف مفعل\n ✇ علامة تعني { ✖ } ملف معطل\n ✇ قناة سورس باور▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n".." ✇ [اضغط هنا لدخول](t.me/bar_lo0o0) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Uouo980/barlo0/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه باور") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✇ تم مسح قائمه باور')
return false
end

if text == 'قائمه باور' and Sudo(msg) then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✇ الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0')..')'
...
' }\n'..' ✇  الايدي بالصوره  ↜:{ '..idph..
' }\n'..' ✇  الرفع  ↜:{ '..setadd..
' }\n'..' ✇  الحظر  ↜:{ '..banm..' }\n\n ✇═───═❲[《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)❳═───═ ✇\n ✇ قناة سورس باور▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\n [ ❲[《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)❳](t.me/bar_lo0o0) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒\nاضغط علي الاسم ليتم نسخه\n▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒ٴ\n ✇ ❲[《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)❳ ✇ ')
end
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس باورو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
end --الكود حصري سورس باوريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باور').." غادر" or text == 'غادر' then  
...
if text == "رتبتي" then
local msg_id = msg.id_/2097152/0.5  
local textt = ' 🌚💘 انت رتبتك  ⤌ '..Rutba(msg.sender_user_id_,msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✇♥️](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/bar_lo0o0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤✇](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..??](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✇💕](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/bar_lo0o0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..✇💕](t.me/bar_lo0o0)')
return false
end
end
end
...
[🎯ألعاب سورس باور الاحسن في التليجرام .↑]
▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
 [《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)
]]
keyboard = {} 
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
 اختر الامر الذي تريدها .↑▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
ده من الازرار بلاسفل . ▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
▒━┅┄⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝┄┉━▒
❲[《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦᪣𝘽𝘼𝙍𝙇𝙊᪣⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦᪣𝘽𝘼𝙍𝙇𝙊᪣⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《♡ 𝘽𝘼𝙍𝙇𝙊》 ](t.me/bar_lo0o0)❳ 
]]
keyboard = {} 
